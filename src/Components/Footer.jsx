...
const Footer = () => {
    ...
    return (
        <footer className="footer footer-horizontal footer-center bg-blue-950 text-white rounded p-10">
            ...
            <aside>
                <p>Copyright © {new Date().getFullYear()} - All right reserved by AthleticsHub</p>
            </aside>
        </footer>
    );
};
